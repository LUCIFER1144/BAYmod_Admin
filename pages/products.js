...
export default function Products({ products, initialLanguage}) { 
    ...
    return (
        <Layout initialLanguage={initialLanguage}>
            <Link className="bg-blue-900 text-white rounded-md py-1 px-2" href={'/products/new'}>{t.AddNewProduct}</Link>
            <table className="basic mt-2">
                ...
                <tbody>
                    ...
                    {products.length === 0 ? (
                        <tr>
                            <td colSpan="2" className="text-center py-4 text-gray-500">{t.NoProductsFound}</td>
                        </tr>
                    ) : (
